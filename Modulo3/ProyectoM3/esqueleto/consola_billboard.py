...
def ejecutar_buscar_cancion(canciones:list)->None:
    ...
    print(f"El resultado es: {bb.buscar_cancion_por_anio(canciones, cancion, anio)}")
...
def ejecutar_canciones_anio(canciones:list)->None:
    ...
    print(f"El resultado: {bb.buscar_canciones_por_anio(canciones, anio)}")
...
def ejecutar_canciones_artista_periodo(canciones:list)->None:
    ...
    print(f"El resultado es: {bb.buscar_canciones_entre_anios_y_artista(canciones, artista, anio_inic, anio_fin)}")
...
def ejecutar_todas_canciones_artista(canciones:list)->None:
    ...
    """
    artista = input("Por favor ingrese el nombre del artista que desea buscar: ")
    print(f"El resultado es: {bb.buscar_canciones_de_artista(canciones, artista)}")
...
def ejecutar_todos_artistas_cancion(canciones:list)->None:
    ...
    print(f"El resultado es: {bb.buscar_canciones_por_nombre(canciones,min)}")
...
def ejecutar_artistas_mas_populares(canciones:list)->None:
    ...
    print(f"El resultado es: {bb.buscar_artistas_con_minimo_de_canciones(canciones,min)}")
     
def ejecutar_artista_estrella(canciones:list)->None:
    """ Ejecuta la opción de consultar el artista estrella de todos los tiempos 
    """
    print(f"El resultado es: {bb.buscar_artista_con_mas_canciones(canciones)}")
...
def ejecutar_artistas_y_sus_canciones(canciones:list)->None:
    ...
    """
    print(f"El resultado es: {bb.buscar_canciones_todos_los_artistas(canciones)}")
...
def ejecutar_promedio_canciones_por_artista(canciones:list)->None:
    ...
    """
    print(f"El resultado es: {bb.promedio_canciones_artistas(canciones)}")
